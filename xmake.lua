...
toolchain("sh3eb-elf-gcc")
    ...
    set_sdkdir("C:/SoftWare/Compiler/PrizmSDK")
    set_bindir("C:/SoftWare/Compiler/PrizmSDK/bin")
    
    on_load(function (toolchain)
        toolchain:add("cxflags", "-fno-exceptions", "-Os", "-Wall", "-ffunction-sections", "-fdata-sections")
        toolchain:add("includedirs", "C:/SoftWare/Compiler/PrizmSDK/include")
        toolchain:add("linkdirs", "C:/SoftWare/Compiler/PrizmSDK/lib")
        toolchain:add("ldflags", "-TC:/SoftWare/Compiler/PrizmSDK/toolchain/prizm.x", "-static", "-gc-sections")
    end)
